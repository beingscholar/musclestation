<?php
/**
 * Template for WP Slick Slider and Image Carousel Pro - prodesign-6
 *
 * This template can be overridden by copying it to yourtheme/wp-slick-slider-and-image-carousel-pro/carousel/prodesign-6.php
 *
		...
		<div class="wpsisac-slider-content">
			<?php if($slick_post_title) { ?>
				<h2 class="wpsisac-slide-title">
					...
					<?php } else { echo $slick_post_title; } ?>
				</h2>
			<?php }
			if($show_content) { ?>
