!(function (a, b) {
  ...
  (function (a) {
      ...
      function b() {
          a(window).width() > 992 &&
              a(".columns-1:not(.exclude-auto-height) .product-outer").each(function () {
                  var b = a(this);
      ...
      function c() {
          a(window).width() > 992 &&
              a("li.product.first:last-child .product-outer").each(function () {
                  var b = a(this),
                      c = "",
                      d = b.parents('[data-toggle="shop-products"]'),
                      e = b.parents('[data-toggle="regular-products"]');
                  d.length > 0 && !d.parents(".exclude-auto-height").length > 0 ? (c = d) : e.length > 0 && !e.parents(".exclude-auto-height").length > 0 && (c = e),
                      c.length > 0 && (b.height("auto"), ("grid" != c.attr("data-view") && "grid-extended" != c.attr("data-view")) || (0 != b.height() && b.height(b.height())));
              });
      }
      void 0 !== a.blockUI &&
          ((a.blockUI.defaults.message = null),
          (a.blockUI.defaults.overlayCSS.background = "#fff url(" + electro_options.ajax_loader_url + ") no-repeat center"),
          (a.blockUI.defaults.overlayCSS.backgroundSize = "16px 16px"),
          (a.blockUI.defaults.overlayCSS.opacity = 0.6)),
          a('[data-toggle="tooltip"]').tooltip(),
          a(document).on("wc_cart_button_updated", function (b, c) {
                  ...
                  b = function () {
                      ...
                      a.each(b, function (b, c) {
                          var e = a(this),
                              ...
                              k = g.width();
                          if (
                              (d ? e.css({ position: "relative", right: j, "box-sizing": "border-box", width: g.width() }) : e.css({ position: "relative", left: j, "box-sizing": "border-box", width: g.width() }),
                              !e.data("vcStretchContent"))
                          ) {
                              var l = -1 * j;
                              l < 0 && (l = 0);
                              var m = k - l - f.width() + h + i;
                              m < 0 && (m = 0), e.css({ "padding-left": l + "px", "padding-right": m + "px" });
                          }
                          e.attr("data-vc-full-width-init", "true");
                      });
                  };
              a(window).unbind("resize.vcRowBehaviour").bind("resize.vcRowBehaviour", b),
                  b(),
                  (function () {
                      var b,
                          c = !1;
                      vcParallaxSkroll && vcParallaxSkroll.destroy(),
                          ...
                          a("[data-vc-parallax]").each(function () {
                              ...
                              (c = !0),
                                  ...
                                  (d = 100 * a(this).data("vcParallax")),
                                  (g = a("<div />").addClass("vc_parallax-inner").appendTo(a(this))),
                                  g.height(d + "%"),
                                  (h = a(this).data("vcParallaxImage")),
                                  void 0 !== h && g.css("background-image", "url(" + h + ")"),
                                  (b = d - 100),
                                  (e = -b),
                                  (f = 0),
                          ...
                          !(!c || !window.skrollr) &&
                              ...
                              (vcParallaxSkroll = skrollr.init(b)),
                              vcParallaxSkroll);
                  })();
          });
      new Array();
      a(window).on("resize", function () {
          ...
          a(".ec-tabs > li > a").on("click", function () {
              if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
                  var b = a(this.hash);
                  (b = b.length ? b : a("[name=" + this.hash.slice(1) + "]")), b.length && ((scrollTo = b.offset().top), a(".sticky-wrapper > .stuck").length > 0 && (scrollTo -= 40), a("html, body").animate({ scrollTop: scrollTo }, 1e3));
              }
          }),
          ...
          a("li.dropdown-submenu > a").on("click", function (b) {
              ...
              d.hasClass("open")
                  ? d.removeClass("open").find("li.dropdown-submenu.open").removeClass("open")
                  : (d.removeClass("open"), d.siblings("li.dropdown-submenu.open").removeClass("open").find("li.dropdown-submenu.open").removeClass("open"), d.addClass("open"));
          }),
          ...
          a(document).on("click", ".add-to-compare-link:not(.added)", function (b) {
              b.preventDefault();
              var c = a(this),
                  d = { _yitnonce_ajax: yith_woocompare.nonceadd, action: yith_woocompare.actionadd, id: c.data("product_id"), context: "frontend" },
                  e = a(".yith-woocompare-widget ul.products-list");
              "undefined" != typeof woocommerce_params && (c.closest(".images-and-summary").block(), c.closest(".product-inner").block(), c.closest(".product-list-view-inner").block(), c.closest(".product-item-inner").block(), e.block()),
                  a.ajax({
                      type: "post",
                      ...
                      dataType: "json",
                      success: function (b) {
                          "undefined" != typeof woocommerce_params && (a(".images-and-summary").unblock(), a(".product-inner").unblock(), a(".product-list-view-inner").unblock(), a(".product-item-inner").unblock(), e.unblock()),
                              c.addClass("added").attr("href", electro_options.compare_page_url).text(yith_woocompare.added_label),
                              e.html(b.widget_table);
                      },
                  });
          }),
          ...
          a(".bg-yamm-extend-outside").closest("ul.dropdown-menu").addClass("bg-yamm-extend"),
          a("body").on("added_to_cart", function () {
          ...
          a("body").on("woocommerce_variation_has_changed", function (b) {
              ...
              a('form.variations_form').on('show_variation', function(event, data) {
                console.log(a(".woocommerce-variation-price").html().length);
                if (a(".woocommerce-variation-price").html().length > 0) {
                  a('.woocommerce p.price').hide('fast');
                }
                console.log('Variation Id '+data.variation_id+' is selected | Hide price');
              });
              // On unselected (or not selected) variation event
              a('form.variations_form').on('hide_variation', function(){
                a('.woocommerce p.price').show('fast');
          ...
          a(".deal-countdown-timer").each(function () {
              var b,
                  ...
                  d,
                  e,
                  f = electro_options.deal_countdown_text,
              ...
              setInterval(function () {
                  ...
                  (b = parseInt(g / 86400)),
                      ...
                      h.html(
                          '<span data-value="' +
                              b +
                              '" class="days"><span class="value">' +
                              b +
                              "</span><b>" +
                              f.days_text +
                              '</b></span><span class="hours"><span class="value">' +
                              c +
                              "</span><b>" +
                              f.hours_text +
                              '</b></span><span class="minutes"><span class="value">' +
                              d +
                              "</span><b>" +
                              f.mins_text +
                              '</b></span><span class="seconds"><span class="value">' +
                              e +
                              "</span><b>" +
                              f.secs_text +
                              "</b></span>"
          ...
          a(document).ready(function () {
              ...
              if (
                  ...
                  a(".price-add-to-cart > .price").each(function () {
                      var c = a(this);
                      c[0].scrollWidth > c.innerWidth() &&
                          (c.find(".electro-price").css("position", "relative"), b ? c.find("del").attr("style", "position:absolute;right:0;top:-14px;") : c.find("del").attr("style", "position:absolute;left:0;top:-14px;"));
                  }),
                  ...
                  var k = a(".vertical-menu > .list-group-item > .dropdown-menu"),
                      l = k.attr("style"),
                      m = 0;
                  k.css({ visibility: "hidden", display: "none" }),
                      (m = k.height() + 15),
                      k.attr("style", l || ""),
                      k.find(".dropdown-menu").each(function () {
                  ...
                  n.find(".dropdown-submenu > .dropdown-menu").each(function () {
                      ...
                      a(".vertical-menu .menu-item-has-children, .departments-menu-dropdown .menu-item-has-children").on({
                          mouseenter: function () {
                              var b = a(this),
                                  ...
                                  f = { width: 540, opacity: 1 },
                                  g = "";
                              d.length > 0 ? (g = d) : e.length > 0 && (g = e),
                                  b.hasClass("yamm-tfw") ? ((f.width = 540), e.length > 0 && (f.width = 600)) : b.hasClass("yamm-fw") ? (f.width = 900) : b.hasClass("yamm-hw") ? (f.width = 450) : (f.width = 277),
                                  c.css({ visibility: "visible", display: "block" }),
                                  g.hasClass("animated-dropdown")
                                      ? c.css(f)
                                      : c.animate(f, 300, function () {
                                            g.addClass("animated-dropdown");
                                        });
                          },
                          mouseleave: function () {
                              a(this).find("> .dropdown-menu").css({ visibility: "hidden", opacity: 0, width: 0, display: "none" });
                          },
                      }),
                      ...
                      a(".electro-animate-dropdown .menu-item, .departments-menu-v2 .menu-item").on("mouseenter", function () {
                          ...
                          if ((c.length > 0 && (d = c), b.hasClass("menu-item-has-children")))
                              d.hasClass("animated-dropdown") ||
                                  setTimeout(function () {
              ...
              if (
                  (a(".handheld-footer.v1 .handheld-widget-menu .widget-title").on("click", function () {
                  ...
                  a(document).on("click", function (b) {
                      a(".site-content").hasClass("active-hh-sidebar") &&
                          (a(".handheld-sidebar-toggle").is(b.target) ||
                              0 !== a(".handheld-sidebar-toggle").has(b.target).length ||
                              a("#sidebar").is(b.target) ||
                              0 !== a("#sidebar").has(b.target).length ||
                              a(".select2-container").is(b.target) ||
                              0 !== a(".select2-container").has(b.target).length ||
                              a(".site-content").toggleClass("active-hh-sidebar"));
                  }),
                  ...
                  a(document).on("click", function (b) {
                      a(".handheld-header-links .search").hasClass("active") &&
                          (a(".handheld-header-links .search").is(b.target) ||
                              0 !== a(".handheld-header-links .search").has(b.target).length ||
                              (a("body").removeClass("disableScroll"), a(".handheld-header-links .search").removeClass("active")));
                  }),
                  ...
                  a(document).on("click", function (b) {
                      a(".handheld-navigation-wrapper").hasClass("toggled") &&
                          (a(".handheld-navigation-wrapper").is(b.target) || 0 !== a(".handheld-navigation-wrapper").has(b.target).length || a(".handheld-navigation-wrapper").toggleClass("toggled"));
                  }),
                  a(".off-canvas-navigation-wrapper .navbar-toggle-hamburger").on("click", function () {
                      var c = { transform: "translateX(250px)", transition: "all .5s" };
                      b && (c.transform = "translateX(-250px)"),
                          a(this).parents(".stuck").length > 0 && a("html, body").animate({ scrollTop: a("body") }, 0),
                          a(this).closest(".off-canvas-navigation-wrapper").toggleClass("toggled"),
                          a("#page").toggleClass("off-canvas-bg-opacity").css(c),
                          a("body").toggleClass("off-canvas-active");
                  }),
                  a(".off-canvas-navigation-wrapper .navbar-toggle-close").on("click", function () {
                      a(this).closest(".off-canvas-navigation-wrapper").removeClass("toggled"), a("#page").css({ transform: "none", transition: "all .5s" }).removeClass("off-canvas-bg-opacity"), a("body").removeClass("off-canvas-active");
                  }),
                  a(document).on("click", function (b) {
                      a(".off-canvas-navigation-wrapper").hasClass("toggled") &&
                          (a(".off-canvas-navigation-wrapper").is(b.target) ||
                              0 !== a(".off-canvas-navigation-wrapper").has(b.target).length ||
                              (a(".off-canvas-navigation-wrapper").removeClass("toggled"), a("#page").css({ transform: "none", transition: "all .5s" }).removeClass("off-canvas-bg-opacity"), a("body").removeClass("off-canvas-active")));
                  }),
              ...
              if (a(window).width() < 1200) {
                  if ("1" == electro_options.enable_sticky_header && a("#page").find(".handheld-navbar-toggle-buttons").length > 0) {
                      new Waypoint.Sticky({ element: a(".handheld-navbar-toggle-buttons")[0], stuckClass: "stuck animated fadeInDown faster" });
                  }
              ...
              if (
                  ...
                  a("body").on("woocommerce_variation_has_changed", function (b) {
                      var c = (a(this).find(".product div.electro-gallery img:eq(0)"), a(this).find(".product div.electro-gallery a.zoom:eq(0)")),
                          d = c.attr("href");
                      "undefined" != typeof variation && variation ? a(this).wc_variations_image_update(variation) : a(this).wc_variations_image_update(!1),
                          a(".single-product .electro-gallery > .thumbnails-single .owl-item").each(function () {
                  ...
                  a('[data-ride="owl-carousel"]').each(function () {
                      ...
                      (b = "self" === d ? c.owlCarousel(e) : c.find(d)),
                          !0 === f &&
                              b.on("initialized.owl.carousel translated.owl.carousel", function () {
                                  a(this)
                                      .find(".owl-item.last-active")
                                      .each(function () {
                  ...
                  a(".single-product .electro-gallery").each(function () {
                      var c = a(this).children(".thumbnails-single"),
                          ...
                          e = !1;
                      c.owlCarousel({ items: 1, margin: 0, dots: !1, nav: !1, rtl: b, responsive: { 0: { items: 1 }, 480: { items: 1 }, 768: { items: 1 } } }),
                      ...
                      var f = d.attr("class"),
                          g = 4;
                      void 0 !== f && (g = parseInt(f.replace("thumbnails-all columns-", ""))),
                          d.owlCarousel({ items: g, margin: 8, dots: !0, nav: !1, rtl: b, responsive: { 0: { items: 1 }, 480: { items: 3 }, 768: { items: g } } }),
                  ...
                  "1" == electro_options.enable_live_search)
              ) {
                  if (electro_options.ajax_url.indexOf("?") > 1)
                      var p = electro_options.ajax_url + "&action=products_live_search&fn=get_ajax_search",
                  ...
                  r.initialize(),
                      a(
                          ...
                          templates: { empty: ['<div class="empty-message">', electro_options.live_search_empty_msg, "</div>"].join("\n"), suggestion: Handlebars.compile(electro_options.live_search_template) },
                      });
              }
          ...
          a(".dokan-store #vendor-biography").length > 0
              ? a(".dokan-store-tabs ul li.vendor_biography").addClass("active")
              : a(".dokan-store #store-toc-wrapper").length > 0
              ? a(".dokan-store-tabs ul li.terms_and_conditions").addClass("active")
              : a(".dokan-store #reviews").length > 0
              ? a(".dokan-store-tabs ul li.reviews").addClass("active")
              : a(".dokan-store #dokan-content").hasClass("store-page-wrap") && a(".dokan-store-tabs ul li.products").addClass("active");
  })(jQuery);
